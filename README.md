...
This fork of RSEM (https://github.com/deweylab/RSEM) adds minor modifications to facilitate using the STAR aligner with RSEM. Use at your risk, and of course, feedback or improvements are welcome! To the best of our ability, we will try to support STAR-specific features and merge any future improvements from the original repository.
...
The following content of this README is the original from the source repository.

ORIGINAL README for RSEM
===============
